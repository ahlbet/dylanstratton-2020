...
const CustomAudioPlayer = ({ src, title, className = '' }) => {
    ...
    >
      ...
      <style
        dangerouslySetInnerHTML={{
          ...
          .custom-audio-player .rhap_main-controls-button.rhap_playing {
          ...
          .custom-audio-player .rhap_time:not(:last-child) {
          ...
          .custom-audio-player .rhap_volume-button svg {
            color: rgba(255, 255, 255, 0.6) !important;
            fill: rgba(255, 255, 255, 0.6) !important;
          }
          
          .custom-audio-player .rhap_volume-button.rhap_volume-button-active svg {
          ...
          /* Target any volume-related icons */
          .custom-audio-player [class*="volume"] svg,
          .custom-audio-player [class*="Volume"] svg {
            color: rgba(255, 255, 255, 0.6) !important;
            fill: rgba(255, 255, 255, 0.6) !important;
          }
          
          /* Force override for any volume icons */
          .custom-audio-player .rhap_controls-section svg {
            color: rgba(255, 255, 255, 0.6) !important;
            fill: rgba(255, 255, 255, 0.6) !important;
          }
          ...
          .custom-audio-player .rhap_additional-controls button {
